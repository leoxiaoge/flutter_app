...
import 'package:flutter_app/shop/widgets/pay_type_dialog.dart';
import 'package:flutter_app/shop/shop_router.dart';
import 'package:flutter_app/shop/widgets/price_input_dialog.dart';
import 'package:flutter_app/shop/widgets/send_type_dialog.dart';
        ...
        children: <Widget>[
          ...
          Visibility(
            ...
            child: ClickItem(
              maxLines: 10,
              title: '运费比例',
              content: '1、订单金额<20元，发货费为订单金额的1%\n2、订单金额≥20元，发货费为订单金额的1%',
